...
const MovieDetails = () => {
  ...
  const handleAddToFavourite = (email, title) => {
    fetch("/favorites", {
      method: "POST",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#3c1c1c] to-[#1e0d0d] text-gray-100">
      <div className="lg:w-4/5 px-5 lg:px-0 mx-auto flex flex-col sm:flex-row items-start lg:items-center gap-8 py-5 sm:py-10 lg:pt-20">
        ...
        <div className="flex-1">
          ...
          <p className="mt-2 text-gray-300">
            Directed by <span className="font-semibold">Abdur Razzak</span>
          </p>
          ...
          <div className="flex gap-4 mt-6">
            <button
              onClick={() => handleAddToFavourite(user.email, movie.title)}
      ...
      <div className="pb-10 lg:pb-20">
        <Link
          to={"/all-movies"}
          className="bg-gray-700 hover:bg-gray-600 px-5 py-2 text-lg font-semibold rounded text-center flex justify-center w-40 mx-auto"
        >
          View All
        </Link>
      </div>
